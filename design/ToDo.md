...
- **F9.** **LAN multiplayer** — Network play over LAN. Requires: menu/lobby system, host/join flow, client-server or peer-to-peer architecture, game state serialization & synchronization, input transmission, latency handling. Large feature — needs detailed design before implementation.
